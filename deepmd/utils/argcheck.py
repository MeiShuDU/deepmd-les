...
@model_args_plugin.register("hybrid_ener")
def hybrid_ener_model_args() -> Argument:
    doc_descrpt = "The descriptor of atomic environment."
    doc_fitting = "The fitting of physical properties."
    doc_les_params = "The parameters for the LES model."
    ca = Argument(
        "hybrid_ener",
        dict,
        [
        ...
        doc="Hybrid LES model with short-range and long-range interactions.",
    )
    return ca
